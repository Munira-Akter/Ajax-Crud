...
<body>
	...
	<div class="wrap-table shadow">
		<div class="clearfix">
			<a href="#modalshow" class="btn btn-info btn-lg"  style="float: left;" data-toggle="modal" >Add Staff</a>
			<form method="post" style="float: right; width: 300px;">
				<input type="search" name="search" id="search" class="form-control-search" placeholder="search here" style="width: 
				300px; padding: 8px;">
				<div id="serch_result">
					<ul>
